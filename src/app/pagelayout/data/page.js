          ...
          <div key={item.id} style={{ backgroundColor: '#f97316', padding: '20px', borderRadius: '10px', color: 'white', margin: '20px' }}>
            ...
            {editId === item.id && (
              <div style={{ color: 'black' }}>
                ...
                />
                <br />
                <button onClick={handleUpdate} className={styles.updateButton} aria-label="Update Event">Update</button>
              </div>
            )}
            <div>
              <button onClick={() => handleEdit(item.id)} className={styles.editButton} aria-label="Edit Event">Edit</button>
              <button onClick={() => handleDelete(item.id)} className={styles.deleteButton} aria-label="Delete Event">Delete</button>
